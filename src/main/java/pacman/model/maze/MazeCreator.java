        ...
        try {
            ...
            while (scanner.hasNextLine()) {
                ...
                for (int x = 0; x < row.length; x++) {
                    ...
                    //if it is a power pellet, letter will be z
                   ...
                   // setStateDuration(Map< GhostMode, Integer> lengths) {
                }

                y += 1;
            }
            //When all ghosts are initialised, give a reference of blinky ghost to bashful/inky
            maze.setBlinky();
